...
// Course data (you can fetch this from Supabase later)
const courses = [
  { id: 'course1', name: 'Full Stack Web Development', price: 19999, link: 'https://enroll/course1' },
  { id: 'course2', name: 'Data Science & AI', price: 24999, link: 'https://enroll/course2' },
  { id: 'course3', name: 'UI/UX Design Bootcamp', price: 14999, link: 'https://enroll/course3' }
];
...
const qualifications = ['10th Pass', '12th Pass', 'Diploma', 'Graduate', 'Post Graduate', 'PhD', 'Other'];
...
const PaymentForm: React.FC = () => {
  ...
  const validateForm = (): boolean => {
    ...
    else if (phoneDigits.length !== 10) errors.phone = 'Phone number must be exactly 10 digits';
    else if (!/^[6-9]\d{9}$/.test(phoneDigits)) errors.phone = 'Please enter a valid Indian mobile number';
    ...
    if (!formData.couponCode.trim()) errors.couponCode = 'Coupon/Affiliate code is required';
    else if (!codeVerified) errors.couponCode = 'Please verify your code first';

    if (!selectedCourse) errors.course = 'Course selection is required';
  ...
  const verifyCouponCode = async () => {
    ...
    try {
      // Replace with real API or Supabase call
    ...
    return (
      <div className="max-w-md mx-auto bg-dark-light rounded-xl p-8 shadow-lg border border-green-500/20">
        <div className="text-center">
          ...
          <p className="text-gray-300 mb-8">Your information has been submitted successfully</p>
  ...
  return (
    <div className="max-w-2xl mx-auto bg-dark-light rounded-xl p-8 shadow-lg border border-primary/10">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-300">Enter your details and coupon/affiliate code to proceed</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        {/* Course Selection */}
        <div>
          <label htmlFor="course" className="block text-white mb-2 font-medium flex items-center">
          ...
          <select
            ...
            className={`w-full px-4 py-3 rounded-lg bg-dark border text-white focus:outline-none transition-all duration-300 ${
              validationErrors.course ? 'border-red-500' : 'border-gray-600'
            }`}
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <p className="text-gray-400 text-xs mt-1">{formData.pincode.length}/6 digits</p>
          </div>
        </div>

        {/* Price and Enroll Button */}
        {selectedCourse && (
          <div className="mt-6 p-4 bg-dark rounded-lg border border-primary/20">
            <h3 className="text-white font-bold">Selected Course:</h3>
            <ul className="text-gray-300 mt-2">
              <li>
                <strong>{courses.find(c => c.id === selectedCourse)?.name}</strong>
              </li>
              <li className="text-green-400 font-bold mt-1">
                ₹{courses.find(c => c.id === selectedCourse)?.price}
              </li>
            </ul>
            <a href={courses.find(c => c.id === selectedCourse)?.link || '#'} target="_blank" rel="noopener noreferrer">
      ...
      <div className="mt-8 pt-6 border-t border-gray-600">
        <div className="text-center">
          <p className="text-gray-400 text-sm mb-3">Need help with your code?</p>
          <a
