/*
  ...
  1. New Tables
    - Enhanced `courses` table with trial and access information
    - `trial_chapters` table for free trial content
    - `user_course_access` table for tracking user access levels

  2. Enhanced Tables
    - Updated `chapters` table with video integration
